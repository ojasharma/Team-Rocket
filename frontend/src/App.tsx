            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16">
              <div className="text-center md:text-left">
                ...
                <p className="text-lg sm:text-xl text-gray-300 leading-relaxed">
                  We are a team of passionate individuals driven by the mission
                  to revolutionize board management for startups.
                </p>
              </div>
              <div className="relative">
                ...
                {/* Option 2: Yellow Quote Box (Instead of Image) */}
                {/* 
            <div className="bg-yellow-400 p-6 rounded-lg shadow-lg text-black">
              <p className="text-lg font-medium italic">
                "A quote that represents your company's values or vision."
              </p>
            </div>
            */}
              </div>
